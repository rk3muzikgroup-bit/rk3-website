...
export default function WatermarkOverlay({ userId = "VAULT-MEMBER" }: Props) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-50">
      ...
      <div
        className={`absolute bottom-6 right-6 text-4xl font-extrabold tracking-widest select-none text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-emerald-400 to-yellow-400 drop-shadow-[0_0_12px_rgba(255,255,255,0.6)] animate-pulse`}
      >
        THE VAULT
      </div>
