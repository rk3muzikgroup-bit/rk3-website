...
export default function StreetIntro() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      new Audio("/sounds/whoosh1.mp3").play().catch(() => {});
      new Audio("/sounds/bass-rumble.mp3").play().catch(() => {});
      new Audio("/sounds/metal-clank.mp3").play().catch(() => {});
      new Audio("/sounds/electric-crackle.mp3").play().catch(() => {});
      ...
      {showIntro && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-96 h-96 rounded-full bg-gradient-to-r from-gray-700 via-gray-900 to-black blur-3xl"
          />
          <motion.div
            animate={
