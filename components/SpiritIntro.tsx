...
export default function SpiritIntro() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      new Audio("/sounds/spirit-wind.mp3").play().catch(() => {});
      new Audio("/sounds/spirit-bell.mp3").play().catch(() => {});
      ...
      {showIntro && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-96 h-96 rounded-full bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-600 blur-3xl"
          />
          <motion.div
            animate={
